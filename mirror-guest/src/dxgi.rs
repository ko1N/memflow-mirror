...
//! This is a modified version of: https://github.com/bryal/dxgcap-rs
...
use winapi::shared::dxgi::{
    ...
    IDXGIOutput, IDXGISurface1, IID_IDXGIFactory1, DXGI_MAP_READ, DXGI_OUTPUT_DESC,
